package com.ttfont.captcha.utils;
...
import com.ttfont.captcha.png.SpecCaptcha;
...
public class CaptchaUtil {
     ...
     * @throws IOException
     */
    public static void out(AbstractCaptchaSource captcha, HttpServletRequest request, HttpServletResponse response)
            throws IOException {
        setHeader(response);
        request.getSession().setAttribute(SESSION_KEY, captcha.text().toLowerCase());
        captcha.out(response.getOutputStream());
