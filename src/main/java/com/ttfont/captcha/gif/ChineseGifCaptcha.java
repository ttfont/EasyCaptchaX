...
import com.ttfont.captcha.support.AbstractChineseCaptcha;
import com.ttfont.captcha.encoder.AnimatedGifEncoder;
...
public class ChineseGifCaptcha extends AbstractChineseCaptcha {
    ...
    @Override
    protected boolean graphicsImage(char[] chars, OutputStream out) throws IllegalAccessException {
        throw new IllegalAccessException("ChineseGifCaptcha 非法访问异常");
    }
